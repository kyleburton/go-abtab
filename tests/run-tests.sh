...
cat ../fixtures/expectations/stratsol.tab | ../abtab -task cat -o "tab://../fixtures/test-output/stratsol.tab"
...
../abtab -task head -n 10 -i tab://../fixtures/expectations/stratsol.tab -o tab://../fixtures/test-output/stratsol-10.tab
...
cat ../fixtures/expectations/stratsol.tab | ../abtab -task head -n 10 > ../fixtures/test-output/stratsol-10.tab
assert_files_identical ../fixtures/expectations/stratsol-10.tab ../fixtures/test-output/stratsol-10.tab
echo_lgreen "OK"
...
cat ../fixtures/expectations/stratsol.tab | ../abtab -task tail -n 10 > ../fixtures/test-output/stratsol-last-10.tab
...
../abtab -task grep -e 'true' -i "tab://../fixtures/expectations/stratsol.tab" > ../fixtures/test-output/stratsol.grep-true.tab
...
../abtab -task grep -e 'gname=="Isabella"' -i "tab://../fixtures/expectations/stratsol.tab" > ../fixtures/test-output/stratsol.grep-Isabella.tab
...
../abtab -task grep -e 'ParseFloat(year_of_birth) >= 1600.0' -i "tab://../fixtures/expectations/stratsol.tab" > ../fixtures/test-output/stratsol.grep-year_of_birth_gt_1600.tab
...
../abtab -task grep -e 'Substr(gname,0,1) == "J"' -i "tab://../fixtures/expectations/stratsol.tab" > ../fixtures/test-output/stratsol.grep-gname-J.tab
...
../abtab -task grep -e 'Substr(gname,-1,0) == "y"' -i "tab://../fixtures/expectations/stratsol.tab" > ../fixtures/test-output/stratsol.grep-gname-last-letter-y.tab
...
echo_lblue -n "  can re-order columns "
../abtab -task head -n 2 -i ../fixtures/fill-rate-test-1.input.tab | ../abtab -task view  > ../fixtures/test-output/abview-1.txt
...
../abtab -task fillrates -i ../fixtures/fill-rate-test-1.input.tab > ../fixtures/test-output/fill-rate-test-1.txt
